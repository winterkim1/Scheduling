...
export const ko = {
  ...
  availability: {
    ...
    preferredNot: "비선호/보류",
    unavailable: "불가",
    unavailableWithEvent: (title: string) => `불가(${title})`,
    calendarLockedHint: "캘린더 일정과 겹쳐 자동으로 불가로 표시됩니다",
  ...
  calendar: {
    ...
    noEventsOnDay: "이 날짜에 예정된 일정이 없습니다",
    registerEvent: "일정 등록",
    editEvent: "수정",
    deleteEvent: "삭제",
    eventFormCreateTitle: "일정 등록",
    eventFormEditTitle: "일정 수정",
    eventFormDescription: "일정 이름과 시간을 입력하세요.",
    eventTitle: "일정명",
    eventTitlePlaceholder: "예: 팀 미팅",
    eventDate: "날짜",
    eventStart: "시작",
    eventEnd: "종료",
    eventCategory: "일정 유형",
    ...
    eventPickEdit: "수정할 일정 선택",
    eventPickDelete: "삭제할 일정 선택",
    eventCreated: "일정이 등록되었습니다",
  ...
  preferredNotConfirmation: {
    title: "일정 확인 요청",
    bodyLine1: "매칭 결과, 일정 후보지에 비선호/보류 시간이 포함되어 있습니다.",
    bodyLine2:

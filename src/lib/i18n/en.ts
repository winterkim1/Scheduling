...
export const en = {
  ...
  availability: {
    ...
    unavailableWithEvent: (title: string) => `Unavailable (${title})`,
    calendarLockedHint:
      "Automatically marked unavailable because it overlaps a calendar event",
  ...
  calendar: {
    ...
    noEventsOnDay: "No scheduled events on this day",
    registerEvent: "Add event",
    editEvent: "Edit",
    deleteEvent: "Delete",
    eventFormCreateTitle: "Add event",
    eventFormEditTitle: "Edit event",
    eventFormDescription: "Enter the event name and time.",
    eventTitle: "Title",
    ...
    eventPickEdit: "Choose an event to edit",
    eventPickDelete: "Choose an event to delete",
    eventCreated: "Event added",
  ...
  preferredNotConfirmation: {
    ...
    bodyLine1:
      "The matching results include a preferred-not time in the schedule candidates.",
    bodyLine2:
